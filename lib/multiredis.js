...
var multiredis = function(_config) {
  ...
  this.masterRedisCommands = [
    // Common
    'set', 'setex', 'setnx', 'append', 'mset', 'setrange', 'del', 'expire',
    'msetnx', 'bitop', 'psetex', 'setbit','decr', 'incr', 'incrby', 'decrby', 'incrbyfloat', 
    // Hashes
    'hset', 'hincrby', 'hincrbyfloat', 'hmset', 'hdel', 'hsetnx',
    // Lists
    'blpop', 'lrem', 'rpush', 'brpop', 'lpop', 'lset', 'rpushx', /*'brpoplpush'*/,
    'lpush', 'ltrim', 'lpushx', 'rpop', 'linsert', /*'rpoplpush'*/,
    // Sets
    'sadd', 'srem', 'spop'
  ];
